...
<div class="mx-auto max-w-2xl">
    ...
    <form method="POST" action="{{ route('tecnicos.store') }}" class="overflow-hidden rounded-2xl bg-white shadow-lg">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required
                        class="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-300 focus:ring-2 focus:ring-[#7C3AED]/20 focus:border-[#7C3AED] transition-all"
                        placeholder="Ej: tecnico@fixbound.com" />
                </div>
            </div>
        ...
        <div class="flex flex-col gap-3 border-t border-gray-100 bg-gray-50 px-4 py-4 sm:flex-row sm:flex-wrap md:px-6">
            ...
            <a href="{{ route('tecnicos.index') }}" class="flex w-full items-center justify-center gap-2 rounded-xl bg-gray-100 px-6 py-2.5 font-medium text-gray-700 transition-all hover:bg-gray-200 sm:w-auto">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
