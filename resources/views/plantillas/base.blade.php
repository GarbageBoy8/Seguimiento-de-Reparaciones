...
<body class="bg-gradient-to-br from-slate-50 to-gray-100 antialiased">
    ...
    <div id="contenedor-principal" class="flex min-h-screen">
        ...
        {{-- Barra lateral --}}
        <aside id="sidebar" class="w-72 bg-[#1E055A] text-white flex flex-col shadow-2xl">
                    ...
                    <li>
                        <a href="{{ route('panel.inicio') }}" 
                           ...
                           {{ request()->routeIs('panel.inicio') ? 'bg-white/20 shadow-lg' : 'hover:bg-indigo-700/50' }}">
                            <span class="w-5 h-5"><svg viewBox="-4.8 -4.8 33.60 33.60" xmlns="http://www.w3.org/2000/svg" fill="#fdf7f7"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title></title> <g id="Complete"> <g id="grid"> <g> <rect fill="none" height="7" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="7" x="14.5" y="2.5"></rect> <rect fill="none" height="7" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="7" x="14.5" y="14.5"></rect> <rect fill="none" height="7" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="7" x="2.5" y="2.5"></rect> <rect fill="none" height="7" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="7" x="2.5" y="14.5"></rect> </g> </g> </g> </g></svg></span> Centro de Mando
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('reparaciones.create') }}" 
                           ...
                           {{ request()->routeIs('reparaciones.create') ? 'bg-white/20 shadow-lg' : 'hover:bg-indigo-700/50' }}">
                            <span class="w-5 h-5"><svg viewBox="-2 -2 24.00 24.00" xmlns="http://www.w3.org/2000/svg" fill="none"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill="#ffffff" fill-rule="evenodd" d="M9 17a1 1 0 102 0v-6h6a1 1 0 100-2h-6V3a1 1 0 10-2 0v6H3a1 1 0 000 2h6v6z"></path> </g></svg></span> Nueva Orden
                        </a>
                    </li>
                    <li>
            ...
            <footer class="p-5 border-t border-indigo-800/50 space-y-3">
                ...
                <form method="POST" action="{{ route('logout') }}">
                    ...
                    <button type="submit" class="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg bg-[#8C0053] hover:bg-[#640039] text-red-200 transition-all duration-200 font-medium text-sm">
                        <span class="w-5 h-5"> <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#FF82B8"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.048"></g><g id="SVGRepo_iconCarrier"> <g id="Interface / Log_Out"> <path id="Vector" d="M12 15L15 12M15 12L12 9M15 12H4M9 7.24859V7.2002C9 6.08009 9 5.51962 9.21799 5.0918C9.40973 4.71547 9.71547 4.40973 10.0918 4.21799C10.5196 4 11.0801 4 12.2002 4H16.8002C17.9203 4 18.4796 4 18.9074 4.21799C19.2837 4.40973 19.5905 4.71547 19.7822 5.0918C20 5.5192 20 6.07899 20 7.19691V16.8036C20 17.9215 20 18.4805 19.7822 18.9079C19.5905 19.2842 19.2837 19.5905 18.9074 19.7822C18.48 20 17.921 20 16.8031 20H12.1969C11.079 20 10.5192 20 10.0918 19.7822C9.71547 19.5905 9.40973 19.2839 9.21799 18.9076C9 18.4798 9 17.9201 9 16.8V16.75" stroke="#FF82B8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg></span> Cerrar sesión
                    </button>
                </form>
            </footer>
        </aside>
